...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.V_ENC_EMBD_CLS: (
            "model.image_encoder.visual_encoder.class_embedding",  # StarVector
            "model.vision_encoder.visual_encoder.class_embedding", # возможный альтернативный путь
            "vision_tower.vision_model.embeddings.class_embedding",
            "vision_model.class_embedding", # llama 4
        ),

        MODEL_TENSOR.V_ENC_EMBD_PATCH: (
            "model.image_encoder.visual_encoder.patch_embedding.weight", # StarVector
            "model.vision_encoder.visual_encoder.patch_embedding.weight",
        ...
        MODEL_TENSOR.V_ENC_EMBD_POS: (
            "model.image_encoder.visual_encoder.positional_embedding", # StarVector
            "model.vision_encoder.visual_encoder.positional_embedding",
        ...
        MODEL_TENSOR.V_ENC_LN_PRE_BIAS: (
            "model.image_encoder.visual_encoder.ln_pre.bias",
        ),

        MODEL_TENSOR.SVG_LN_F_BIAS: (
            "model.svg_transformer.transformer.transformer.ln_f.bias",
        ),
        MODEL_TENSOR.SVG_LN_F_WEIGHT: (
            "model.svg_transformer.transformer.transformer.ln_f.weight",
        ),
        MODEL_TENSOR.SVG_WPE_WEIGHT: (
            "model.svg_transformer.transformer.transformer.wpe.weight",
        ),
        MODEL_TENSOR.SVG_WTE_WEIGHT: (
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.LN_VISION_BIAS: (
            "model.image_encoder.ln_vision.bias",
        ),
        MODEL_TENSOR.LN_VISION_WEIGHT: (
            "model.image_encoder.ln_vision.weight",
        ),
        MODEL_TENSOR.V_ENC_LN_PRE_WEIGHT: (
            "model.image_encoder.visual_encoder.ln_pre.weight",
        ),
        MODEL_TENSOR.V_ENC_LN_1_BIAS: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.ln_1.bias",
        ),
        MODEL_TENSOR.V_ENC_LN_1_WEIGHT: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.ln_1.weight",
        ),
        MODEL_TENSOR.V_ENC_LN_2_BIAS: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.ln_2.bias",
        ),
        MODEL_TENSOR.V_ENC_LN_2_WEIGHT: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.ln_2.weight",
        ),
        MODEL_TENSOR.V_ENC_ATTN_IN_PROJ_BIAS: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.attn.in_proj_bias",
        ),
        MODEL_TENSOR.V_ENC_ATTN_IN_PROJ_WEIGHT: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.attn.in_proj_weight",
        ),
        MODEL_TENSOR.V_ENC_ATTN_OUT_PROJ_BIAS: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.attn.out_proj.bias",
        ),
        MODEL_TENSOR.V_ENC_ATTN_OUT_PROJ_WEIGHT: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.attn.out_proj.weight",
        ),
        MODEL_TENSOR.V_ENC_MLP_C_FC_BIAS: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.mlp.c_fc.bias",
        ),
        MODEL_TENSOR.V_ENC_MLP_C_FC_WEIGHT: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.mlp.c_fc.weight",
        ),
        MODEL_TENSOR.V_ENC_MLP_C_PROJ_BIAS: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.mlp.c_proj.bias",
        ),
        MODEL_TENSOR.V_ENC_MLP_C_PROJ_WEIGHT: (
            "model.image_encoder.visual_encoder.transformer.resblocks.{bid}.mlp.c_proj.weight",
        ),
        MODEL_TENSOR.SVG_ATTN_C_ATTN_BIAS: (
            "model.svg_transformer.transformer.transformer.h.{bid}.attn.c_attn.bias",
        ),
        MODEL_TENSOR.SVG_ATTN_C_ATTN_WEIGHT: (
            "model.svg_transformer.transformer.transformer.h.{bid}.attn.c_attn.weight",
        ),
        MODEL_TENSOR.SVG_ATTN_C_PROJ_BIAS: (
            "model.svg_transformer.transformer.transformer.h.{bid}.attn.c_proj.bias",
        ),
        MODEL_TENSOR.SVG_ATTN_C_PROJ_WEIGHT: (
            "model.svg_transformer.transformer.transformer.h.{bid}.attn.c_proj.weight",
        ),
        MODEL_TENSOR.SVG_LN_1_BIAS: (
            "model.svg_transformer.transformer.transformer.h.{bid}.ln_1.bias",
        ),
        MODEL_TENSOR.SVG_LN_1_WEIGHT: (
            "model.svg_transformer.transformer.transformer.h.{bid}.ln_1.weight",
        ),
        MODEL_TENSOR.SVG_LN_2_BIAS: (
            "model.svg_transformer.transformer.transformer.h.{bid}.ln_2.bias",
        ),
        MODEL_TENSOR.SVG_LN_2_WEIGHT: (
            "model.svg_transformer.transformer.transformer.h.{bid}.ln_2.weight",
        ),
        MODEL_TENSOR.SVG_MLP_C_FC_BIAS: (
            "model.svg_transformer.transformer.transformer.h.{bid}.mlp.c_fc.bias",
        ),
        MODEL_TENSOR.SVG_MLP_C_FC_WEIGHT: (
            "model.svg_transformer.transformer.transformer.h.{bid}.mlp.c_fc.weight",
        ),
        MODEL_TENSOR.SVG_MLP_C_PROJ_BIAS: (
            "model.svg_transformer.transformer.transformer.h.{bid}.mlp.c_proj.bias",
        ),
        MODEL_TENSOR.SVG_MLP_C_PROJ_WEIGHT: (
            "model.svg_transformer.transformer.transformer.h.{bid}.mlp.c_proj.weight",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_C_FC_BIAS: (
            "model.image_projection.c_fc.bias",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_C_FC_WEIGHT: (
            "model.image_projection.c_fc.weight",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_C_PROJ_BIAS: (
            "model.image_projection.c_proj.bias",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_C_PROJ_WEIGHT: (
            "model.image_projection.c_proj.weight",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_NORM_BIAS: (
            "model.image_projection.norm.bias",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_NORM_WEIGHT: (
            "model.image_projection.norm.weight",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_NORM_RUNNING_MEAN: (
            "model.image_projection.norm.running_mean",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_NORM_RUNNING_VAR: (
            "model.image_projection.norm.running_var",
        ),
        MODEL_TENSOR.IMAGE_PROJECTION_NORM_NUM_BATCHES_TRACKED: (
            "model.image_projection.norm.num_batches_tracked",
        ),
    }
