...
# Тест: StarVector vision/text (пример)
./mtmd-cli \
  -m ../../star-vector-main/starvector-1b-im2svg/model.gguf \
  --mmproj ../../star-vector-main/starvector-1b-im2svg/vision-encoder.gguf \
  --image ../../star-vector-main/assets/starvector-teaser.png \
  -p "Опиши изображение на русском языке."
